...
/**
 * Autocomplete para Recurso usando endpoint de filtros-populados
 * Props: value, onChange, equipeId
 */
export default function AutocompleteRecursoFiltro({ value, onChange, equipeId }) {
  ...
  function handleInputChange(e) {
    ...
    timeoutRef.current = setTimeout(() => buscarRecursos(val), 300);
  ...
  return (
    <div style={{ position: 'relative', width: 240 }}>
      <label style={{ display: 'block', marginBottom: 4, fontWeight: 600, fontSize: 14, color: '#00579D' }}>Recurso</label>
      <input
        type="text"
        value={inputValue}
        onChange={handleInputChange}
        onFocus={() => { setShowSugestoes(true); buscarRecursos(inputValue); }}
