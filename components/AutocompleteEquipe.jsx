...
import { buscarEquipesPorNome } from '../utils/autocomplete';
 ...
 */
export default function AutocompleteEquipe({ value, onChange, placeholder = 'Digite o nome da equipe...' }) {
  ...
  async function handleInputChange(e) {
    ...
    if (val.length >= 2) {
      timeoutRef.current = setTimeout(async () => {
        const sugests = await buscarEquipesPorNome(val);
